...
export async function POST(request) {
    try {
        ...
        // User requested to remove approval for payment/input. 
        // We will allow 'staff' and 'agent' to register directly unless they are 'partners'.
        // Partners usually stay pending for owner review. 
        if (userRole === 'partner') {
            ...
            try {
                ...
                await sendNotification({
                    title: 'Pendaftaran Baru (Partner)',
                    message: `Pelanggan ${body.customerName || finalUsername} telah didaftarkan oleh Partner ${user.fullName || user.username} dan memerlukan verifikasi.`,
                    type: 'alert',
                    ownerId: ownerId,
